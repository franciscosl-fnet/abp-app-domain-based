...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a576c6f6-70fd-47cd-9f04-47ee81898532
```

> `a576c6f6-70fd-47cd-9f04-47ee81898532` is the password of the certificate, you can change it to any password you want.
...
* `AbpSolution1.Blazor`: ASP.NET Core Blazor Server application that is the essential web application of the solution.
